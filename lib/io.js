...
module.exports = class IO {
  // + host null uses IPv6 :: by default
  constructor (table, udx, { maxWindow = 80, port = 0, host = null, anyPort = true, firewalled = true, onrequest, onresponse = noop, ontimeout = noop } = {}) {
    this.table = table
    this.udx = udx
    this.inflight = []
