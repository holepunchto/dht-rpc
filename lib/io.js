...
module.exports = class IO {
  ...
  createRequest(to, token, internal, command, target, value, session, ttl, timeoutMs) {
...
class Request {
  constructor(
    ...
    this.timeoutMs = timeoutMs || 1_000
  ...
  _sendNow() {
    ...
    this._timeout = setTimeout(oncycle, this.timeoutMs, this)
  }
