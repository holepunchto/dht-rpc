...
module.exports = class IO {
  constructor(
    ...
    udx,
    {
      ...
      maxHealthWindow = MAX_HEALTH_WINDOW,
      port = 0,
      host = '0.0.0.0',
      anyPort = true,
      firewalled = true,
    ...
    this.health = new NetworkHealth(this, { maxHealthWindow })
...
class NetworkHealth {
  constructor(io, { maxHealthWindow = MAX_HEALTH_WINDOW } = {}) {
    this._io = io
  ...
  update() {
    this._window.push({ ...this._io.stats.requests })
    ...
    this.online = someResponses || this._window.length < this._maxHealthWindow
    this.degraded = this.online && someTimeouts
  }
}
module.exports.NetworkHealth = NetworkHealth
