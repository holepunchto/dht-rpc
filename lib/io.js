...
module.exports = class IO {
  ...
  async _clear (suspended) {
    ...
    while (this.inflight.length) {
      ...
      req.onerror(suspended ? IO_SUSPENDED() : REQUEST_DESTROYED(), req, { downHint: false })
    }
...
class Request {
  ...
  destroy (err, { downHint = true }) {
    downHint = downHint !== false && err !== undefined
    ...
    this.onerror(err || REQUEST_DESTROYED(), this, { downHint })
  }
