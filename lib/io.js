...
module.exports = class IO {
  constructor(
    ...
    this._internalCommandsRateLimit = [
      'ping' in internalCommandsRateLimit ? internalCommandsRateLimit.ping : -1,
      'pingNat' in internalCommandsRateLimit ? internalCommandsRateLimit.pingNat : -1,
      'findNode' in internalCommandsRateLimit ? internalCommandsRateLimit.findNode : -1
    ]
