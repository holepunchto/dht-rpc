...
module.exports = class IO {
  constructor (table, { maxWindow = 80, port = 0, udx, firewalled = true, onrequest, onresponse = noop, ontimeout = noop } = {}) {
    this.table = table
    this.inflight = []
  ...
  async _bindSockets () {
    const serverSocket = this._udx.createSocket()
    ...
    const clientSocket = this._udx.createSocket()
